...
const AdminReports = () => {
  const monthlyData = [
    { month: 'Jan', loans: 45, customers: 120, transactions: 850 },
    { month: 'Feb', loans: 52, customers: 98, transactions: 920 },
    { month: 'Mar', loans: 38, customers: 156, transactions: 1100 },
    { month: 'Apr', loans: 67, customers: 134, transactions: 1350 },
    { month: 'May', loans: 71, customers: 187, transactions: 1250 },
    { month: 'Jun', loans: 89, customers: 203, transactions: 1480 },
  ];

  const loanTypeData = [
    { name: 'Personal', value: 35, color: '#8884d8' },
    { name: 'Auto', value: 28, color: '#82ca9d' },
    { name: 'Home', value: 25, color: '#ffc658' },
