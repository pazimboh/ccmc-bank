  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        console.log("Fetched accounts data from Supabase:", JSON.stringify(fetchedAccounts, null, 2));
                      ...
                      {isLoading && accountsData.length === 0 ? (
                        ...
                        accountsData.map((account) => (
                          ...
                          <AccountSummary
                            ...
                            account={{
                              id: account.id,
                              account_name: account.account_name, // Use account_name from DB
                              type: account.type,
                      ...
                      <Card key={account.id}>
                        <CardHeader>
                          <div className="flex items-center justify-between">
                            <CardTitle>{account.account_name}</CardTitle> {/* Use account_name */}
